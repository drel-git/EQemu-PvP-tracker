...
Logs player-vs-player kills during timed events, announces kills (either zone or worldwide), keeps temporary per-event stats (kills/deaths/ratio), and exports results in **Markdown** (for Discord) and **CSV** (for spreadsheets). Can be used either temporarily or longterm.
